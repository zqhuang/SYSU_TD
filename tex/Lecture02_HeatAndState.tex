...
\item[3]{试估算通常状态下液态水(原子量18，密度$1\SIg/\SIcm^3$)和铁块(原子量56，密度$7.9\SIg/\SIcm^3$)分子之间的平均距离，并跟典型的$r_0$比较。}
\eitem
\ech
\end{frame}
...
\begin{frame}
\chtitle{第二周作业（续第一周作业1.-3.）}
\bch
\bitem
\item[4]{一碗米饭大概含有$300\SIkcal$的热量，试估算这些能量能够把一个体重$60\SIkg$的人举到多高。}
\item[5]{可以浮在水上的金属纳（原子量23，密度$0.97\SIg/\SIcm^3$）是比较另类的金属，试估算它的原子间平均距离。}
\item[6]{教材习题1-16}
\eitem
\ech
\end{frame}
