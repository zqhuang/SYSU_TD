...
\chtitle{焓的参考点：标准生成焓}
\bch
焓和势能一样，可以取任意参考点，习惯上定义$1\atm$, $25\cdeg$的纯元素的焓为零。

\skipline

$1\atm$，$25\cdeg$下化合物的生成焓定义为化合物的标准生成焓。

\skipline

$1\atm$，$25\cdeg$下，

化学反应的反应焓 = 合成物的标准生成焓 - 反应物的标准生成焓

\skiplines

标准生成焓可以通过查表获得。见教材145页表3-3。计算化学反应的反应焓的例子见145页至146页。
