...
所以压强为
\bea
\sum_{\upsilon_x}(2p_x\upsilon_x) n(\upsilon_x) &=& n \frac{\sum_{\upsilon_x>0}(2p_x\upsilon_x) n(\upsilon_x)}{2\sum_{\upsilon_x>0} n(\upsilon_x)} \newl
&=& n \overline{p_x \upsilon_x}|_{\upsilon_x>0} \newl
&=& n \overline{p_x \upsilon_x} \newl
&=& \frac{1}{3}n\left(\overline{p_x \upsilon_x} +  \overline{p_y \upsilon_y} + \overline{p_z \upsilon_z} \right) \newl
&=& \frac{1}{3}n\, \overline{\mathbf{p}\cdot\mathbf{\upsilon}}
\eea
}
